...
# Let's write a Stack class. To do this, use the following framework:
  ...
  class Stack
    ...
    def peek
      # returns, but doesn't remove,ls the top element in the stack
      @stack_arr.last 
    end
  end

# To test that your code works, create a new instance of the Stack class, and play around with adding 
# and removing elements. Remember, a stack follows the principle of LIFO!
...
# Note that the set method can be used to either create a new key-value pair or update the value for a 
